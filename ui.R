...
ui <- (fluidPage(
  ...
  choices = c("1. Samples load, read and plot","2. Wavelet Analysis & Energy Sequence","3. CHMM Training", 
              "4. Prognostics"),
  ...
  ##  3.c  CHMM Training
  conditionalPanel(condition = "input.Steps == '3. CHMM Training'",
                   wellPanel(h5("Train samples:"),
                             fileInput("file1","Upload Training Samples", multiple = TRUE),
                             selectInput(inputId = "Trainparameters",label = "Training Parameters", 
